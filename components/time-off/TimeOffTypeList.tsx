        ...
        <Table>
          <TableHeader className="bg-popover">
            <TableRow className="border-b-[#2D3342] hover:bg-transparent">
              ...
              <TableHead className="text-muted-foreground font-medium">Allocation</TableHead>
              <TableHead className="text-muted-foreground font-medium">Approval</TableHead>
          ...
          <TableBody>
            {filtered.length === 0 ? (
              ...
              filtered.map((type) => (
                <TableRow key={type.id} className="border-b-[#2D3342] hover:bg-popover/50 transition-colors">
                  <TableCell className="font-medium text-popover-foreground flex items-center gap-2">
                    {type.color && (
                      <div className="w-3 h-3 rounded-full" style={{ backgroundColor: type.color }} />
                    )}
                    {type.name}
                  </TableCell>
                  <TableCell className="text-muted-foreground capitalize">{type.unit.toLowerCase()}</TableCell>
                  ...
                  <TableCell>
                    <Badge variant="outline" className={type.active ? "border-green-500/50 text-green-400 bg-green-500/10" : "border-slate-500/50 text-muted-foreground bg-muted0/10"}>
