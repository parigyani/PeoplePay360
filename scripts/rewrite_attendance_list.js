...
const pageContent = `import { getServerSession } from "next-auth/next";
...
`;
fs.writeFileSync('/Users/utkarsingh/Documents/PeoplePay360/app/attendance/page.tsx', pageContent);
