...
// 1. Rewrite app/attendance/[id]/page.tsx
const editPageContent = `import { getServerSession } from "next-auth/next";
...
`;
fs.writeFileSync('/Users/utkarsingh/Documents/PeoplePay360/app/attendance/[id]/page.tsx', editPageContent);

// 2. Create components/attendance/AttendanceDetailView.tsx
const detailViewContent = `"use client";
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <FormItem>
                <FormLabel>Overtime (Est. via Schedule)</FormLabel>
...
`;
fs.writeFileSync('/Users/utkarsingh/Documents/PeoplePay360/components/attendance/AttendanceDetailView.tsx', detailViewContent);
